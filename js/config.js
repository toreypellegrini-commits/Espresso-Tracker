...
const ACHIEVEMENTS = [
  ...
  { id:'turbo_charged',    icon:'⚡⚡', name:'Turbo Charged',      desc:'Log 10 shots with ratio 1:3+' },
  { id:'zuppa_lunga',      icon:'🫗', name:'Zuppa Lunga',         desc:'Log a shot with ratio 1:8 or higher' },
  ...
  { id:'won_the_game',     icon:'🥇', name:'You Won the Game',    desc:'Dial 100 different bags' },
  ...
  { id:'sleep_overrated',  icon:'😵', name:'Sleep is Overrated',  desc:'Log 4 shots in one day' },
  ...
  { id:'ooey_gooey',       icon:'🍯', name:'Ooey Gooey',          desc:'Log a shot with ratio under 1:1.5' },
